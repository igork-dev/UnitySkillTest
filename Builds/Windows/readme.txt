---------------------------------------------------------------------------------------
Тестовое задание для iLogos. Кулаков Игорь.
...
* Нажмите на путом месте рабочей области. Вершина будет создана.
...
---------------------------------------------------------------------------------------------------
Копирование кадра
* Вы можете переключиться на определённый кадр и нажать "Copy frame", и в на рабочую область скопируется предедущий не пустой кадр.
Это сделано для удобства последовательного создания кадров. ( Хоткей "C" )
